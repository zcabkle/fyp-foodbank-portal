...
export default async function (context, req) {  
    ...
    var url = process.env.DATABASE_CONNECTION_STRING + `cr967_parcels?$filter=_cr967_foodbankkey_value eq ${id} and cr967_shareparcelwith eq 2&$select=cr967_name,cr967_image,cr967_description,cr967_parcelpk`;
